...
COPY --chown=1000:1000 /example-api/src/main/resources/newrelic/newrelic.yml app/newrelic/
COPY --chown=1000:1000 /build/libs/newrelic.jar app/newrelic/newrelic.jar
COPY --chown=1000:1000 /example-api/build/libs/example-api-1.0-SNAPSHOT.jar app/api.jar
